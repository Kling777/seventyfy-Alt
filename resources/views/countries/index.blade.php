<x-app-layout>
    ...
    @endif
    @if(session('error'))
    <div class="p-4 mb-4 text-sm text-red-800 bg-green-50 dark:bg-gray-800 dark:text-red-400">
        {{ session('error') }}
    </div>
    @endif
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="">
                <div class="flex justify-between text-center">
                    <h1 class="text-4xl font-extrabold ms-6 justify-start">Countries</h1>
                                ...
                                <td class="px-6 py-4">
                                    <form method="POST" action="{{ route('country.destroy', $country->id) }}">
                                        ...
                                        <button type="submit"
                                            ...
                                            onclick="return confirm('Are you sure you want to delete this country name?');">Delete</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
